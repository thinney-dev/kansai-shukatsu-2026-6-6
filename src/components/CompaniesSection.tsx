...
const CompaniesSection = () => {
  ...
  const companies = [
    ...
    { 
      ...
      url: "https://www2.deloitte.com/jp/ja/pages/strategy/articles/dtvs/deloitte-tohmatsu-venture-support.html",
      details: {
        catchphrase: "挑戦者と共に、ベンチャーと大企業を繋ぎ未来を創る",
        stats: [
          { label: "支援実績", value: "数千社以上のスタートアップ支援ネットワーク" },
          { label: "Morning Pitch", value: "累計登壇2,500社超の日本最大級ピッチイベント" },
          { label: "事業領域", value: "ベンチャー支援・大企業新規事業・官公庁受託" },
          { label: "グローバル拠点", value: "世界30都市以上を拠点とした海外進出支援" }
        ],
        strength: "デロイト トーマツ ベンチャーサポート（DTVS）は、ベンチャー企業の成長支援と、大企業のオープンイノベーションを両輪で加速させるプロフェッショナル集団です。最大の強みは、2013年から続く毎週開催のピッチイベント『Morning Pitch』に象徴される、スタートアップエコシステムにおける圧倒的なネットワークと信頼にあります。単なるコンサルティングに留まらず、ベンチャーには「大企業との提携・販路拡大・資金調達」を、大企業には「外部知見を活用したスピーディな新規事業創出」を提供し、双方を繋ぐブリッジ（架け橋）としての役割を果たしています。官公庁とも深く連携し、日本全体の起業家精神の醸成や、スタートアップの海外進出支援においても圧倒的な実績を誇る、挑戦者のためのファームです。"
      }
    },
    { 
      id: 3, 
